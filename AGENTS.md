...
- Install package without build isolation (fast rebuilds): `uv sync --inexact --no-dev --no-build-isolation-package mqt-scpd`
...
- NEVER edit `.pyi` files in `python/mqt/scpd/` manually; they are auto-generated by nanobind stubgen.

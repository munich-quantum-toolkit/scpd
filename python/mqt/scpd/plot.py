...
the core writes no SVG. See decision 0021. The layout view draws the obstacles and the ports colored
...
budget of decision 0021 applies to the raster views of the later stages.
"""

...
from mqt.scpd.generated.PortPatterns import PortPatterns
from mqt.scpd.generated.PortSequences import PortSequences
...
import mqt.scpd.generated.PortPatterns
import mqt.scpd.generated.PortSequences
try:
    from typing import Optional
except:
    pass
...
class PortConfigT(object):
    ...
    def __init__(
        ...
        self.patterns = patterns  # type: Optional[mqt.scpd.generated.PortPatterns.PortPatternsT]
        self.detection = detection  # type: int
        self.startComponent = startComponent  # type: Optional[str]
        self.sequences = sequences  # type: Optional[mqt.scpd.generated.PortSequences.PortSequencesT]
    ...
    def _UnPack(self, portConfig):
        ...
        if portConfig.Patterns() is not None:
            self.patterns = mqt.scpd.generated.PortPatterns.PortPatternsT.InitFromObj(portConfig.Patterns())
        ...
        if portConfig.Sequences() is not None:
            self.sequences = mqt.scpd.generated.PortSequences.PortSequencesT.InitFromObj(portConfig.Sequences())

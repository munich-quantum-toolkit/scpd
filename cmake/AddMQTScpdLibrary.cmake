...
#
# add_mqt_scpd_library(<module> [ALIAS_NAME <name>] [GENERATED_HEADERS <file>...]
#                      [LINK_LIBRARIES <target>...])
#
# The function creates the target `mqt-scpd-<module>` with the alias `MQT::Scpd<Module>`. It collects
# the public headers from `include/mqt-scpd/<module>/` and the sources from `src/<module>/`. The
# headers form a `FILE_SET HEADERS` whose base directory is `include/`, so a header is included as
# `mqt-scpd/<module>/<Header>.hpp`.
#
...
function(add_mqt_scpd_library module)
  ...
  target_sources(${name} ${scope} FILE_SET HEADERS BASE_DIRS ${MQT_SCPD_INCLUDE_BUILD_DIR} FILES
                 ${headers})

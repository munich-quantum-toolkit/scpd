...
```console
python -c "import mqt.scpd; print(mqt.scpd.__version__)"
```
...
```console
pip install mqt.scpd --no-binary mqt.scpd
```
...
To use the MQT SCPD Python package in your project,
...
- install MQT SCPD on your system
...
because it lets you detect installed versions of MQT SCPD
...
1. Get the code: <!-- rumdl-disable-line MD013 -->
   ...
   [munich-quantum-toolkit/scpd](https://github.com/munich-quantum-toolkit/scpd)

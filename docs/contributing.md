...
- 🐛 Report bugs:
  ...
  <https://github.com/munich-quantum-toolkit/scpd/issues>. Include steps to
...
- 💡 Propose features:
  ...
  <https://github.com/munich-quantum-toolkit/scpd/issues>. Describe the
...
{code}`-DBUILD_MQT_SCPD_TESTS=OFF` to the CMake configure step.
:::
...
MQT SCPD adheres to [Semantic Versioning], with the exception that minor
...
explain how users may need to adapt their usage of MQT SCPD, highlight new
